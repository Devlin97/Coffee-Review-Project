  ...
  return (
    <div className='about-holder'> 
        <Stack>
            ...
            <p>The aeropress has two different orientations with which it can brew coffee. The first orientation is the standard method. For this the aeorpress sits directly overtop your mug/carafe and sits like this while you're waiting to plunge your coffee. This is the most common way, but since the bottom of the aeropress is open so the coffee can be plunged, some coffee will leak out during the brew process. The inverted method seeks to cure this. For the inverted method the aeropress has the plunger inserted into it and is sat upside town on the countertop. This allows for no coffee to be spilled during the brew process but you will have to flip the aeorpress to plunge the coffee. Even though you should be fine some spills are known to have occured!</p>
        </Stack>
    </div> 
  )
}
