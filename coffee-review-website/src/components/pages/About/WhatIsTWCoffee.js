  ...
  return (
    <div className='about-holder'> 
        <Stack>
            ...
            <p>Now that you brewed third wave coffee, how should you drink it? Because brewing a cup of third wave coffee takes so much more time and effort to create, it is usually enjoyed black without and sweeteners or milk. To get into this cup your coffee has been grown for years, cultivated, probably shipped halfway across the world, roasted to impart the flavours into it, and then grinded and brewed by you! Brewing coffe in these ways lets you taste all the subtleties and complexities of the coffee.</p>
